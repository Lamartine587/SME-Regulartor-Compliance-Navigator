    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-900 dark:from-slate-950 to-indigo-900 dark:to-indigo-950 p-4">
      <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-800 p-10 rounded-2xl shadow-2xl w-full max-w-md space-y-6">
        ...
        <div className="space-y-4">
          <div>
            <input required type="text" placeholder="000000" maxLength="6" value={emailOtp} onChange={(e) => setEmailOtp(e.target.value.replace(/\D/g, ''))} className="w-full border border-gray-300 dark:border-gray-600 p-3 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none bg-gray-50 dark:bg-slate-700 text-gray-900 dark:text-white text-center tracking-[0.5em] text-xl font-mono" />
          </div>
        </div>
